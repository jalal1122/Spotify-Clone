...
async function getSongs(playListPath) {
  ...
  if (playListPath === "" || playListPath === undefined) {
    ...
    response = await fetch(`https://api.github.com/repos/jalal1122/Spotify-Clone/assets/music/`);
  }
  // if the playlist path is not empty
  else {
    // get the songs from the playlist
    response = await fetch(
      `${encodeURI(`https://api.github.com/repos/jalal1122/Spotify-Clone/assets/Playlists/${playListPath}/`)}`
    );
  }
...
function playSong(song) {
  ...
  if (currentPlayList === "") {
    ...
    song = `https://api.github.com/repos/jalal1122/Spotify-Clone/assets/music/${song}`;
  }
  // if the current playlist is not empty
  else {
    // set the song to the playlist
    song = `https://api.github.com/repos/jalal1122/Spotify-Clone/assets/Playlists/${currentPlayList}/${song}`;
  }
...
async function getPlaylists() {
  ...
  let response = await fetch("https://api.github.com/repos/jalal1122/Spotify-Clone/assets/Playlists/");
